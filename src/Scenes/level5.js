class Level5 extends Phaser.Scene {
    ...
    create() {
        ...
        //Map
        this.map = this.add.tilemap("level5Set", 18, 18, 0, 0);
        ...
        //Layers
        this.shootingLayer = this.map.createLayer("Shooting", this.tileset, 0, 0).setDepth(7);
        ...
        //Player
        this.player = this.physics.add.sprite(40, 1414, "platformer_characters", "tile_0000.png").setDepth(7);
        ...
        this.cameras.main.setZoom(this.SCALE - 0.04);
        ...
        this.events.on(Phaser.Scenes.Events.POST_UPDATE, () => updateHUD(this.coinText, this.keysText, this.timerText, this.pauseIMG, this.resumeBtn, this.restartBtn, this.exitBtn, this.cameras.main, true), this);
    }
    ...
    killPlayer(player, tileOrBullet) {
        if (tileOrBullet && tileOrBullet.texture) {
            tileOrBullet.destroy();
        }
    ...
    reachFlag(player, tile) {
        if (this.keys == 3) {
            ...
            const levelStats = window.dataStats.level5;
            ...
            this.time.delayedCall(120, () => {
                ...
                btnContainer.add([ restartBtn, exitBtn ]);
            });
        }
    }
