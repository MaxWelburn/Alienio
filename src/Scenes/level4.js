class Level4 extends Phaser.Scene {
    ...
    create() {
        ...
        //Map
        this.map = this.add.tilemap("level4Set", 18, 18, 0, 0);
        ...
        //Layers
        this.movingLayerL = this.map.createLayer("MovingL", this.tileset, 0, 0).setDepth(7);
        this.movingLayerR = this.map.createLayer("MovingR", this.tileset, 0, 0).setDepth(7);
        ...
        this.movingLayerL.setCollisionByExclusion([-1]);
        this.movingLayerR.setCollisionByExclusion([-1]);
        ...
        this.physics.add.collider(this.player, this.movingLayerL);
        this.physics.add.collider(this.player, this.movingLayerR);
    ...
    reachFlag(player, tile) {
        if (this.keys == 3) {
            ...
            const levelStats = window.dataStats.level4;
            ...
            this.time.delayedCall(120, () => {
                ...
                const nextBtn = this.add.image(0, 0, 'nextBTN')
                    ...
                    .on('pointerup', () => this.scene.start('level5Scene'));
